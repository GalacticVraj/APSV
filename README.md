...
| `npm test` | 146 tests (carbon, optimiser, logistics, forecasting, scenarios, copilot, carbon history, traceability, pathway choice, API validation) |
...
packages/engine    Domain model, carbon science, optimiser, forecasting.
                   Pure TypeScript. Zero runtime dependencies. 146 tests.
