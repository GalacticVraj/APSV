...
| `npm test` | 166 tests (carbon, optimiser, logistics, forecasting, scenarios, copilot, carbon history, traceability, pathway choice, facility carbon, API validation) |
...
packages/engine    Domain model, carbon science, optimiser, forecasting.
                   Pure TypeScript. Zero runtime dependencies. 166 tests.
