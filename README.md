...
| `npm test` | 260 tests (carbon, optimiser, logistics, forecasting, scenarios, copilot, carbon history, traceability, pathway choice, facility carbon, evidence, opportunities, shock engine, intelligence brief, permanence contract, cross-module invariants, API validation) |
...
packages/engine    Domain model, carbon science, optimiser, forecasting.
                   Pure TypeScript. Zero runtime dependencies. 260 tests.
